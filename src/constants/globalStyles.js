...
export default {
  ...
  // text
  // ///////////////////////////////////////////////////////////////////////////
  textartnative10: { fontFamily: fonts.artnativeRegular, fontSize: 10 },
  textartnative12: { fontFamily: fonts.artnativeRegular, fontSize: 12 },
  textartnative14: { fontFamily: fonts.artnativeRegular, fontSize: 14 },
  textartnative16: { fontFamily: fonts.artnativeRegular, fontSize: 16 },
  textartnative18: { fontFamily: fonts.artnativeRegular, fontSize: 18 },
  textartnativeBold12: { fontFamily: fonts.artnativeBold, fontSize: 12 },
  textartnativeBold16: { fontFamily: fonts.artnativeBold, fontSize: 16 },
  textartnativeBold18: { fontFamily: fonts.artnativeBold, fontSize: 18 },
  textartnativeBold20: { fontFamily: fonts.artnativeBold, fontSize: 20 },
  textartnativeBold22: { fontFamily: fonts.artnativeBold, fontSize: 22 },
  textartnativeBold24: { fontFamily: fonts.artnativeBold, fontSize: 24 },
